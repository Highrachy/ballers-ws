...
<section class="faq-category">
    ...
    <div class="faq-category-slider">
        <div class="faq-category-slide">
            <img src="./assets/img/icons/profile-icon.png" class="faq-category-slide-img" alt="Profile">
            <h5 class="faq-category-slide-text">Profile</h5>
        </div>
        <div class="faq-category-slide">
            <img src="./assets/img/icons/geting-started-icon.png" class="faq-category-slide-img" alt="Profile">
            <h5 class="faq-category-slide-text">Getting Started</h5>
        </div>
        <div class="faq-category-slide">
            <img src="./assets/img/icons/payment-icon.png" class="faq-category-slide-img" alt="Profile">
            <h5 class="faq-category-slide-text">Payment</h5>
        </div>
        <div class="faq-category-slide">
            <img src="./assets/img/icons/security-icon.png" class="faq-category-slide-img" alt="Profile">
                ...
                <a class="" data-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                  <h5 class="mb-0 faq-card-heading">
                    ...
                    <span class="icon-toggle">
                      <span class="faq-getting-started-icon one">-</span>
                    </span>
                  </h5>
                </a>
              </div>
...
<section class="faq-question">
    ...
    <div class="faq-question-contact col-12">
        <div class="col-lg-4 col-md-5 col-12 faq-question-info-div">
        ...
        <div class="col-lg-4 col-md-5 col-12 faq-question-info-div">
            ...
            <h4 class="faq-question-info">support@ballers.ng</h4>
