...
<section class="about-holding">
    ...
    <h5 class="about-holding-text">The only realistic burden free process <br> of owning your ideal home.</h5>
</section>

<section class="about-goal row">
    <div class="col-lg-5 col-12">
        <h6 class="about-goal-title">OUR GOAL</h6>
...
<section class="about-goal row">
    <div class="col-lg-5 col-12">
        <h6 class="about-goal-title">OUR PROMISE TO YOU</h6>
...
<section class="about-team">
    <h6 class="about-team-title">THE TEAM</h6>
    <h2 class="about-team-heading">Meet our <br> awesome team.</h2>
...
<section class="about-gallery">
    <h6 class="about-gallery-title">COMMUNITY GALLERY</h6>
