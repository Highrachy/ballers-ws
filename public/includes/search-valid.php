    ...
    <section class="search-ready">
        ...
        <div class="col-lg-8 search-ready-step investment-initial">
          ...
          <div class="row custom-range-div">
            <div class="form-group col-sm-6 col-12">
              ...
              <input type="range" class="custom-range" id="initial-investment" name="" min="100000" max="30000000"
            ...
            <div class="input-group col-sm-6 col-12">
              ...
              <input type="text" class="form-control investment-value-input" placeholder="500,000"
                data-max-amount="30,000,000" aria-label="Username" aria-describedby="initial-investment">
            </div>
          </div>
        </div>
        <div class="col-lg-2"></div>
        ...
        <div class="col-lg-8 search-ready-step investment-periodic">
          ...
          <div class="row custom-range-div">
            <div class="form-group col-sm-6 col-12">
              ...
              <input type="range" class="custom-range" id="periodic-investment" name="" min="50000" max="5000000"
            ...
            <div class="input-group col-sm-6 col-12">
              ...
              <input type="text" class="form-control investment-value-input" placeholder="100,000"
                data-max-amount="5,000,000">
            </div>
          </div>
        </div>
        <div class="col-lg-2"></div>
      ...
      <div class="row search-ready-investments">
        ...
        <div class="col-lg-8 search-ready-awesome">
          ...
          <p class="search-ready-text">You’re just one plan away from owning your home. <br> Consider one of the plans
            below.</p>

          <a tabindex="0" class="btn" id="search-ready-awesome-spread" role="button" data-toggle="popover">
            <h5 class="search-ready-awesome-spread-text">Spread Payment <img src="./assets/img/icons/question-mark.svg"
                alt="spread payment"></h5>
          </a>
          <br>

          <button class="btn search-ready-awesome-eligibility"><span>&#8592;</span> Eligibility status</button>
          <a class="btn search-ready-awesome-create" data-fancybox data-src="#register-popup" href="javascript:;">Create
            free account</a>
