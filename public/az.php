...
<section class="az-how">
    <h6 class="az-how-title">HOW IT WORKS</h6>
    <h4 class="az-how-title-2">In three easy steps</h4>
...
<section class="az-creed">
    <img class="az-creed-q-up" src="./assets/img/icons/quote-up.png" alt="quotation mark">
    <h6 class="az-creed-title">BALLERS CREED</h6>
    <h4 class="az-creed-heading">As a BALLer, we share a duty to BALL <br> and live a healthy lifestyle for it’s not <br> just a home but also a lifestyle</h4>
    <img class="az-creed-q-down" src="./assets/img/icons/quote-down.png" alt="quotation mark">
    <img class="az-creed-q-up-mobile" src="./assets/img/icons/quote-up.png" alt="quotation mark">
</section>

<section class="az-message row">
...
<section class="about-gallery">
    <h6 class="about-gallery-title">START BALLING</h6>
    <h2 class="about-gallery-heading">Take a deep dive into <br> what your home looks like</h2>
